...
var svgSprite = '<svg>' +
  ...
  ''+
    ...
    '</symbol>'+
  ''+
    '<symbol id="icon-xindianji" viewBox="0 0 1024 1024">'+
      ''+
      '<path d="M832 403.2c0-89.6-73.6-163.2-163.2-163.2-44.8 0-83.2 19.2-115.2 48-22.4 22.4-64 22.4-86.4 0-28.8-28.8-70.4-48-115.2-48-89.6 0-160 73.6-163.2 163.2 0 0 0 3.2 0 6.4 3.2 166.4 204.8 310.4 284.8 361.6 22.4 12.8 48 12.8 70.4 0 76.8-48 256-176 281.6-326.4C828.8 435.2 832 409.6 832 403.2z"  ></path>'+
      ''+
    '</symbol>'+
  ''+
'</svg>'
